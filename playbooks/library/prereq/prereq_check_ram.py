"""This module perform ram checks.

Called from mapr_prereq.py, inherit from MapRPrereqCheck.
"""
...
class PrereqCheckRAM(MapRPrereqCheck):
    ...
    def process(self):
        ...
        self.set_state(MapRPrereqCheck.VALID)#  force min ram used in the cluster
